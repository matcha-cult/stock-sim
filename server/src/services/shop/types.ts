...
export const SHOP_TYPE_CONFIG: Record<ShopType, {
  ...
  [SHOP_TYPES.MINERAL]: { name: '矿材', initialArea: 40, initialRent: 20, purchaseCost: 150000 },
  [SHOP_TYPES.ARTIFACT]: { name: '法器', initialArea: 35, initialRent: 18, purchaseCost: 120000 },
  [SHOP_TYPES.PILL]: { name: '丹药', initialArea: 30, initialRent: 15, purchaseCost: 80000 },
  [SHOP_TYPES.FOOD]: { name: '餐饮', initialArea: 25, initialRent: 13, purchaseCost: 50000 },
